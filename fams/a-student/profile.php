      ...
      <div class="col-md-12">
        <div class="widget">
          <header class="widget-header">
            <h3 class="widget-title">Student Profile</h3>
...
{               ?>
            <form class="form-horizontal" method="post">
              <div class="form-group">
                <label for="exampleTextInput1" class="col-sm-3 control-label">Student ID:</label>
                <div class="col-sm-9">
              ...
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Program:</label>
                <div class="col-sm-9">
