...
<body>
 ...
 ';
        ...
        echo '<script>alert("ERROR while sending email. ' . $e->getMessage() . '")</script>';
        return false;
    }
}
                                ...
                                <form role="form" method="post">
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                            <input type="text" name="Fname" id="name" class="form-control" placeholder="Fullname" value="<?php echo $result[0]->FullName; ?>" readonly required='true'>

                                        </div>
                                        <div class="col-lg-6 col-12">
                                            <input type="email" name="email" id="email" pattern="[^ @]*@[^ @]*" class="form-control" placeholder="Email address (optional)" value="<?php echo $result[0]->Email; ?>" readonly required='true'>
                                        </div>

                                        <script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
                                        <div class="col-lg-6 col-12">

                                            <input type="text" name="STid" id="schoolID" class="form-control" placeholder="Student ID"  value="<?php echo $result[0]->user_ID; ?>"readonly required='true'>
                                        </div>
                                      
                                        <div class="col-lg-6 col-12">
                                            <input type="telephone" name="phone" id="phone" class="form-control" placeholder="Enter Phone Number" maxlength="11" value="<?php echo $result[0]->MobileNumber; ?>" readonly required='true'>
                                        </div>
